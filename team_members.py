...
def get_team_members(file_path: Optional[Path] = None) -> List[TeamMember]:
    ...
    if file_path is None:
        file_path = Path(__file__).parent / "team.md"
...
def get_member_by_username(
    username: str, file_path: Optional[Path] = None
) -> Optional[TeamMember]:
    """
...
def get_members_by_role(
    role: str, file_path: Optional[Path] = None
) -> List[TeamMember]:
    """
...
def print_team_roster(file_path: Optional[Path] = None) -> None:
    """
