# Spec 83 — Subsystem 11 integration design

## Overview

This spec defines the integration contract for subsystem-11 with
the platform's request envelope and identity context. It is consumed by
service teams that own producers and consumers of subsystem-11.

## Scope

In scope:
- Request envelope shape v1.83
...
|---|---|---|---|---|
| GET | /v1/subsystem-11/items | Bearer | — | { items: Item[] } |
| POST | /v1/subsystem-11/items | Bearer | { name, scope } | { id, name, created_at } |
| DELETE | /v1/subsystem-11/items/{id} | Bearer | — | 204 |
...
- 403 forbidden — tenant lacks subsystem-11 access
