# Runbook 32 — Incident response for subsystem-8

## Symptoms

- Pages from synthetic-monitor-32 firing
- Error rate > 1% for /api/route-32 for 5 minutes
- Latency p99 > 500ms

## Triage

1. Check service-8 dashboard at grafana.example/d/32
...
- Disable feature flag `subsystem_8_v32` via the flag UI
