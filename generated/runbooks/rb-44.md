# Runbook 44 — Incident response for subsystem-8

## Symptoms

- Pages from synthetic-monitor-44 firing
- Error rate > 1% for /api/route-44 for 5 minutes
- Latency p99 > 500ms

## Triage

1. Check service-8 dashboard at grafana.example/d/44
...
- Disable feature flag `subsystem_8_v44` via the flag UI
