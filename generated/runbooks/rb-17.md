# Runbook 17 — Incident response for subsystem-5

## Symptoms

- Pages from synthetic-monitor-17 firing
- Error rate > 1% for /api/route-17 for 5 minutes
- Latency p99 > 500ms

## Triage

1. Check service-5 dashboard at grafana.example/d/17
...
- Disable feature flag `subsystem_5_v17` via the flag UI
