# Runbook 40 — Incident response for subsystem-4

## Symptoms

- Pages from synthetic-monitor-40 firing
- Error rate > 1% for /api/route-40 for 5 minutes
- Latency p99 > 500ms

## Triage

1. Check service-4 dashboard at grafana.example/d/40
...
- Disable feature flag `subsystem_4_v40` via the flag UI
