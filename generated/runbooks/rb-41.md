# Runbook 41 — Incident response for subsystem-5

## Symptoms

- Pages from synthetic-monitor-41 firing
- Error rate > 1% for /api/route-41 for 5 minutes
- Latency p99 > 500ms

## Triage

1. Check service-5 dashboard at grafana.example/d/41
...
- Disable feature flag `subsystem_5_v41` via the flag UI
