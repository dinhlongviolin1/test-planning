# Runbook 20 — Incident response for subsystem-8

## Symptoms

- Pages from synthetic-monitor-20 firing
- Error rate > 1% for /api/route-20 for 5 minutes
- Latency p99 > 500ms

## Triage

1. Check service-8 dashboard at grafana.example/d/20
...
- Disable feature flag `subsystem_8_v20` via the flag UI
