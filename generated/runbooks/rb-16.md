# Runbook 16 — Incident response for subsystem-4

## Symptoms

- Pages from synthetic-monitor-16 firing
- Error rate > 1% for /api/route-16 for 5 minutes
- Latency p99 > 500ms

## Triage

1. Check service-4 dashboard at grafana.example/d/16
...
- Disable feature flag `subsystem_4_v16` via the flag UI
