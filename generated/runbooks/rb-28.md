# Runbook 28 — Incident response for subsystem-4

## Symptoms

- Pages from synthetic-monitor-28 firing
- Error rate > 1% for /api/route-28 for 5 minutes
- Latency p99 > 500ms

## Triage

1. Check service-4 dashboard at grafana.example/d/28
...
- Disable feature flag `subsystem_4_v28` via the flag UI
