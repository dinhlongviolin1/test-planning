# Runbook 29 — Incident response for subsystem-5

## Symptoms

- Pages from synthetic-monitor-29 firing
- Error rate > 1% for /api/route-29 for 5 minutes
- Latency p99 > 500ms

## Triage

1. Check service-5 dashboard at grafana.example/d/29
...
- Disable feature flag `subsystem_5_v29` via the flag UI
